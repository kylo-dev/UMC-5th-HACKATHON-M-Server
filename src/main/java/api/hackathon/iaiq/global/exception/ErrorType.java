package api.hackathon.iaiq.global.exception;
...
public enum ErrorType {
    ...
    // ------------------------------------------ QUESTION ------------------------------------------
    _QUESTION_NOT_FOUND(NOT_FOUND, "QUESTION_4000", "존재하지 않는 질문입니다."),

    // ------------------------------------------ ANSWER ------------------------------------------
    _ANSWER_NOT_FOUND(NOT_FOUND, "ANSWER_4000", "존재하지 않는 질문입니다."),
